...
//        test_path(10,1);
    ...
    public static graph graph_creator(int v_size, int e_size, int seed) {
        System.out.println(v_size + "_ "+ e_size + "_ "+ seed);
...
//            System.out.println("Connected: "+i + " and "+ j);
            g.connect(i,j);
        }
        return g;
    }
    ...
    public static void test_n(int size, int edge, int seed, int tt, int jump) {
      ...
      //  System.out.println(g);
        ...
        boolean b = true;
        while(i<=tt) {
            System.out.println("b alone: " + b);
            System.out.println(g.toString());
            boolean flag = ga.isConnected();
            System.out.println("ga.isConnected alone: " + flag);
            b &= flag;
            System.out.println("b together : " + b);
