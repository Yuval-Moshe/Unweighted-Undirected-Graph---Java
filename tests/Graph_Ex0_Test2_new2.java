...
public class Graph_Ex0_Test2_new2 {
    ...
    public static void test2a() {
        ...
        boolean b = ga0.isConnected();
        test("test2(a) ", b, true);
        System.out.println("test2a: finished");
    ...
    public static void test9() {
        ...
        System.out.println("test9(a)+9(b): finished");
    ...
    public static void test_n(int size, int edge, int seed, int tt, int jump) {
        ...
        System.out.println("test_n(a)+_n(b): finished : with:" + size + " " +edge );
        ;
    }
