 ...
 * In this Class I chose to use HashMap as the DS to represented the nodes and edges of the graph.
 ...
 * about a specific node in the graph at O(1) time complexity & retirve a collection of all the nodes in the graph in O(1)
 * time compexity.
...
public class Graph_DS implements graph {
    ...
    @Override
    /** Adds a new node to the graph by mapping him in the HashMap by is unique key
    ...
    @Override
    /** Returns a collection of all the nodes in the graph by returning the HashMap.values() in O(1) complexity
    ...
    @Override
    /**Returns a collection of all the nodes connected to a a specific node
     ...
     * (and by that also deleting him from their neighbors collection) and then removing him from the HashMap
     * of the graph.
